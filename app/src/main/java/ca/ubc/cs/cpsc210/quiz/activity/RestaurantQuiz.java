...
public class RestaurantQuiz extends Activity implements OnMapReadyCallback {
    // Constants
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        CameraUpdate cameraUpdate = CameraUpdateFactory.newLatLng(new LatLng(49.0, -123.0));
